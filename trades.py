...
trades = {
    "Buys": {
        ...
        "trades": [
            ...
            Trade(buy_item="minecraft:pumpkin", buy_quantity=4, sell_item="minecraft:emerald", sell_quantity=1, price_multiplier=0.05, max_uses=8, weight=1),
        ]
    },
    "Trades": {
        "minimum_quantity": 1,
    ...
    "Blocks": {
        ...
        "trades": [
            ...
            Trade(buy_item="minecraft:emerald", buy_quantity=1, sell_item="minecraft:blue_ice", sell_quantity=1, price_multiplier=0.05, max_uses=16, weight=1),
    ...
    "Plants": {
        ...
        "trades": [
            ...
            Trade(buy_item="minecraft:emerald", buy_quantity=1, sell_item="minecraft:moss", sell_quantity=4, price_multiplier=0.05, max_uses=4, weight=1),
            Trade(buy_item="minecraft:emerald", buy_quantity=1, sell_item="minecraft:pale_moss", sell_quantity=4, price_multiplier=0.05, max_uses=4, weight=1),
